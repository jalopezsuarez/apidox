		...
		<div class="row">
			...
			<div class="col-md-10 content">
				...
				<div class="row">
					...
					<div class="col-md-5 pull-right apidox-section-server">
						<div class="apidox-server">
							<div class="title">API Server</div>
							<input id="server" name="server" data-name="server" type="text" value="<?php echo $apidox->getScheme() . trim($apidox->getUri(), '/') ?>" data-schema="<?php echo $apidox->getScheme() ?>" data-server="<?php echo trim($apidox->getUri(), '/') ?>">
						</div>
					</div>
				...
				<div class="row">
								...
								<tbody>
									...
									<tr data-name="params">
										...
										<td class="description">
											...
											<td data-name="param" class="field"><?php echo $paramsResource[Apidox::NAME] ?></td>
										<td class="value" colspan="3"><input data-name="value" type="file" name="<?php echo $paramsResource[Apidox::NAME] ?>" /></td>
					...
					<div class="col-md-5 pull-right apidox-section-response">
						...
						<div class="apidox-request">
							...
							<a target="_blank" href="http://api.soydeunica.net/api-v1/acceso/entrar?idalmacen=001&idusuario=5010&tipousuario=SOCIO&password=780lop&plataforma=UNICAGES">
								<span id="schema" class="schema" data-schema="<?php echo $apidox->getScheme() ?>"><?php echo $apidox->getScheme() ?></span>
								<span id="server" class="server" data-server="<?php echo trim($apidox->getUri(), '/') ?>"><?php echo trim($apidox->getUri(), '/') ?></span>
								<span id="uri" class="uri" data-uri="<?php echo '/' . trim($methodResource[Apidox::URI], '/') ?>"><?php echo '/' . trim($methodResource[Apidox::URI], '/') ?></span>
							</a>
						</div>
